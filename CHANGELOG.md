...
- **Chat History** (#27): Chat session history and session management
  ...
  - Session list accessible via "会话历史" tab
...
- **Infographic Generation** (#2, #13): Transform content into visual infographics
  ...
  - Hand-drawn/illustration style designs with Chinese language support
...
### Documentation
- **Multilingual Docs** (#21): Enhanced documentation in multiple languages
  - Chinese (简体中文)
